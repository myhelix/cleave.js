...
/***/ function(module, exports, __webpack_require__) {
	...
	var NumeralFormatter = __webpack_require__(4);
	var DateFormatter = __webpack_require__(5);
	var PhoneFormatter = __webpack_require__(6);
	...
	var Cleave = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var _$omit = _.omit(owner.props, ['value', 'options', 'onKeyDown', 'onChange', 'onInit']);

	        var propsToTransfer = _objectWithoutProperties(_$omit, []);

	        return React.createElement('input', _extends({}, propsToTransfer, {
	            type: 'text',
